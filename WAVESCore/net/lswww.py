...
from WAVESCore.net import jsoncookie
from WAVESCore.net import HTTP
from WAVESCore.net import swf_parser
from WAVESCore.net import lamejs
...
class lswww(object):
    ...
    Supported options are:
        ...
        -i <file>
        --continue <file>
            This parameter indicates WAVES to continue with the scan
            from the specified file, this file should contain data
            from a previous scan.
            The file is optional, if it is not specified, WAVES takes
    ...
    def go(self, crawler_file):
        ...
        if crawler_file is not None:
            if self.persister.isDataForUrl(crawler_file) == 1:
                ...
                print(_("File {0} not found, WAVES will scan again the web site").format(crawler_file))
        ...
        try:
            ...
            print(("To continue this scan, you should launch WAVES with the \"-i\" parameter"))
            pass
